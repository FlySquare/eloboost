...
<!-- sidebar end -->
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$valorantelosiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['valorantelosiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 6) {
        $lig = "Elmas";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 7) {
        $lig = "Ölümsüzlük";

      }elseif ($eloboostsipariscek['valorantelosiparis_mevcutlig'] == 8) {
        $lig = "Işıyan";

      }
     echo $lig." / ".$eloboostsipariscek['valorantelosiparis_mevcutasama'];
     ?></td>
    <td><?php
    if ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 1) {
      $lig2 = "Demir";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 2) {
      $lig2 = "Bronz";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 3) {
      $lig2 = "Gümüş";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig']== 4) {
      $lig2 = "Altın";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 5) {
      $lig2 = "Platin";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 6) {
      $lig2 = "Elmas";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 7) {
      $lig2 = "Ölümsüzlük";

    }elseif ($eloboostsipariscek['valorantelosiparis_hedeflig'] == 8) {
      $lig2 = "Işıyan";

    }
     echo $lig2." / ".$eloboostsipariscek['valorantelosiparis_hedefasama']; ?></td>
    <td><?php

    echo $eloboostsipariscek['valorantelosiparis_karakter']; ?></td>
    <td><?php

     echo $eloboostsipariscek['valorantelosiparis_sunucu']; ?></td>

    <td><?php echo $eloboostsipariscek['valorantelosiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['valorantelosiparis_hesapad']; ?></td>
    <td><?php echo $eloboostsipariscek['valorantelosiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['valorantelosiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['valorantelosiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['valorantelosiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['valorantelosiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
