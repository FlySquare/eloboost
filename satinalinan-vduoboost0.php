...
<!-- sidebar end -->
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$valorantduoboostsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['valorantduoboostsiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 6) {
        $lig = "Elmas";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 7) {
        $lig = "Ölümsüzlük";

      }elseif ($eloboostsipariscek['valorantduoboostsiparis_mevcutlig'] == 8) {
        $lig = "Işıyan";

      }
     echo $lig." / ".$eloboostsipariscek['valorantduoboostsiparis_mevcutasama'];
     ?></td>
    <td><?php
    if ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 1) {
      $lig2 = "Demir";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 2) {
      $lig2 = "Bronz";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 3) {
      $lig2 = "Gümüş";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig']== 4) {
      $lig2 = "Altın";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 5) {
      $lig2 = "Platin";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 6) {
      $lig2 = "Elmas";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 7) {
      $lig2 = "Ölümsüzlük";

    }elseif ($eloboostsipariscek['valorantduoboostsiparis_hedeflig'] == 8) {
      $lig2 = "Işıyan";

    }
     echo $lig2." / ".$eloboostsipariscek['valorantduoboostsiparis_hedefasama']; ?></td>
    <td><?php

    echo $eloboostsipariscek['valorantduoboostsiparis_karakter']; ?></td>
    <td><?php

     echo $eloboostsipariscek['valorantduoboostsiparis_sunucu']; ?></td>

    <td><?php echo $eloboostsipariscek['valorantduoboostsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['valorantduoboostsiparis_hesapad']; ?></td>
    <td><?php echo $eloboostsipariscek['valorantduoboostsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['valorantduoboostsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['valorantduoboostsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['valorantduoboostsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['valorantduoboostsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
