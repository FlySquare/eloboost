...
<!-- sidebar end -->
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Geçen Sezon Lig</th>
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$ilk5macsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['ilk5macsiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 6) {
        $lig = "Elmas";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 7) {
        $lig = "Ölümsüzlük";

      }elseif ($eloboostsipariscek['ilk5macsiparis_sonlig'] == 8) {
        $lig = "Işıyan";
    ...
    <td><?php
     ...
     echo $eloboostsipariscek['ilk5macsiparis_toplammac']; ?></td>
    <td><?php

    echo $eloboostsipariscek['ilk5macsiparis_karakter']; ?></td>
    <td><?php

     echo $eloboostsipariscek['ilk5macsiparis_sunucu']; ?></td>

    <td><?php echo $eloboostsipariscek['ilk5macsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['ilk5macsiparis_hesapad']; ?></td>
    <td><?php echo $eloboostsipariscek['ilk5macsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['ilk5macsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['ilk5macsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['ilk5macsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['ilk5macsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
