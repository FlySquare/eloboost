...
<html lang="tr">
	<head>
		...
		<title><?php echo "Valorant Duo Boost - ".$ayarcek['ayar_title']; ?></title>
...
<!-- section start -->
				...
				<div class="section">
					<div class="container">
							...
							<div class="col-md-12 bhoechie-tab-container">
								...
								<div class="col-md-2 bhoechie-tab-menu">
								  <div class="list-group">
									...
									<a href="valorant-duoboost" class="list-group-item active text-center">
										<img src="/frontend/images/valorant/duo.png"><p class="boostB">Duo Boost</p>
									</a>
									<a href="valorant-ilk5mac" class="list-group-item text-center">
								...
								<div class="col-md-9 bhoechie-tab">
									...
									<div class="bhoechie-tab-content active">
										...
										<h1 class="text-center"><strong>Duo Boost Hizmeti</strong></h1>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="lcurrent_rank" id="lcurrent_rank" v-model="lcurrent_rank" required>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="lcurrent_stage" id="lcurrent_stage" v-model="lcurrent_stage" required>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="server" id="server" v-model="server" required>
                          ...
                          <option v-bind:value="1">TR</option>
											...
											<?php
											if ($valorantduoboostfiyatcek['valorantduoboostfiyat_indirimdurum'] == "1") {
												?>
                    ...
                    <?php if (isset($_SESSION['user_username'])): ?>
											<center>  <button name="valorantduoboost"
													type="submit"
                    ...
                    <?php endif; ?>
                      ...
                      <input type="hidden" name="mevcutlig" id="mevcutlig" value="">
                      <input type="hidden" name="mevcutasama" id="mevcutasama" value="">
                      <input type="hidden" name="hedeflig" id="hedeflig" value="">
                      <input type="hidden" name="hedefasama" id="hedefasama" value="">
										...
										<form id="hesapbilgileri">
												...
												<div class="form-group has-feedback">
												  <label for="recipient-name" class="col-form-label required">Kullanıcı Adı:</label>
													<input type="text" class="form-control" name="kullaniciAdi" id="kullaniciAdi" placeholder="Valorant kullanıcı adınız" maxlength="50" required>
													<i class="fa fa-user form-control-feedback"></i>
												</div>
												<div class="form-group has-feedback">
												  <label for="recipient-name" class="col-form-label required">Şifre:</label>
													<input type="text" class="form-control" name="sifre" id="sifre" placeholder="Valorant şifreniz" maxlength="50" required>
												...
												<input type="hidden" name="_token" value="4YAsBPCeBnJzUxePTJJqHLVfGkrYX7mHa40G8muW">
										</form>
								</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-sm btn-dark" data-dismiss="modal">İPTAL</button>
									<button type="button" class="btn btn-sm btn-default" onclick="gonder('ilk5mac');">SİPARİŞİ ONAYLA</button>
								</div>
							</div>
						</div>
				</div>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
									<form id="hesapbilgileri3">
											<div class="form-group has-feedback">
											<label for="recipient-name" class="col-form-label required">Riot Adı:</label>
											  <input type="text" class="form-control" name="sihirdarAdi" id="sihirdarAdi" placeholder="Riot adınız#Etiket" maxlength="50" required>
				...
				<!-- NORMAL MAÇ -->
				<div class="modal fade" id="6hesapbilgileri" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Kapat</span></button>
							...
							<div class="modal-body">
									<form id="hesapbilgileri6">

											<div class="form-group has-feedback" id="6kullaniciAdi">
											  <label for="recipient-name" class="col-form-label required">Kullanıcı Adı:</label>
												<input type="text" class="form-control" name="kullaniciAdi" id="kullaniciAdi" placeholder="Valorant kullanıcı adınız" maxlength="50">
												<i class="fa fa-user form-control-feedback"></i>
											</div>
											<div class="form-group has-feedback" id="6sifre">
											  <label for="recipient-name" class="col-form-label required">Şifre:</label>
												<input type="text" class="form-control" name="sifre" id="sifre" placeholder="Valorant şifreniz" maxlength="50">
												<i class="fa fa-lock form-control-feedback"></i>
											</div>
											<div class="form-group has-feedback">
												<label for="message-text" class="col-form-label">Sipariş Notu:</label>
							...
							<div class="modal-footer">
								<button id="6siparistutari" type="button" class="btn btn-sm btn-success"></button>
								<button type="button" class="btn btn-sm btn-dark" data-dismiss="modal">İPTAL</button>
								<button type="button" class="btn btn-sm btn-default" onclick="gonder('normalmac');">SİPARİŞİ ONAYLA</button>
							</div>
						</div>
					</div>
				</div>
...
data: {
	...
	ranked_type: 1,
	priceList: { 1: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_demir']; ?>, 2: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_bronz']; ?>, 3: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_gumus']; ?>, 4: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_altin']; ?>, 5: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_platin']; ?>, 6: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_elmas']; ?> ,7: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_olumsuzluk']; ?>,8: <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_isiyan']; ?> },
},
methods: {
	calcOrder() {
		var price = 0;
		...
		if (this.pre_discount_boost_order <= 0) {
			this.after_discount_boost_order = "Hata. Hedef lig mevcut liginizin Üzerinde Olmalıdır!";
			this.pre_discount_boost_order = null;
		}
		<?php
		if ($valorantduoboostfiyatcek['valorantduoboostfiyat_indirimdurum'] == "1") {
			?>
			this.after_discount_boost_order = (this.pre_discount_boost_order * <?php echo $valorantduoboostfiyatcek['valorantduoboostfiyat_indirim']; ?>).toFixed(0);
