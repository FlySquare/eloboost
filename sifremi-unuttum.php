...
<head>
		...
		<title><?php echo "Şifremi Unuttum - ".$ayarcek['ayar_title']; ?></title>
							...
							<div class="form-block center-block">
								...
								<form class="form-horizontal" method="POST" action="db/islem.php">
									<div class="form-group has-feedback ">
											...
											<div class="col-sm-8">
												<input type="email" class="form-control" id="eposta" name="user_eposta" placeholder="E-posta adresiniz" value="" required>
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-8">
											<button type="submit" name="usersifreyenile" class="btn btn-group btn-default btn-sm">GÖNDER</button>
										</div>
									</div>
								</form>
							</div>
							<p class="text-center space-top">Yeni şifre talebiniz için yukarıdaki alana sitemizde kayıt e-posta adresinizi yazınız.</p>
						</div>
						<!-- main end -->
