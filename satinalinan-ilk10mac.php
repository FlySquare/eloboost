...
<html lang="tr">
	<head>
		...
		<title><?php echo "Satın Alınan İlk 10 Maç - ".$ayarcek['ayar_title']; ?></title>
...
<!-- sidebar end -->
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Son Lig</th>
      <th scope="col">Toplam Maç</th>
      <th scope="col">Duo Boost</th>
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$ilk10macsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['ilk10macsiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['ilk10macsiparis_sonlig'] == 6) {
        $lig = "Elmas";

      }
     echo $lig;
     ?></td>
    <td><?php echo $eloboostsipariscek['ilk10macsiparis_toplammac']; ?></td>
    <td><?php

     if ($eloboostsipariscek['ilk10macsiparis_duoboost'] == "1") {
      echo "İstemiyorum";
    }elseif ($eloboostsipariscek['ilk10macsiparis_duoboost'] == "1.5") {
      echo "İstiyorum";
    }; ?></td>
    <td><?php
    if ($eloboostsipariscek['ilk10macsiparis_sunucu'] == "1") {
      $busunucu = "TR";
    }elseif ($eloboostsipariscek['ilk10macsiparis_sunucu'] == "1.5") {
    $busunucu = "EU";
    }
     echo $busunucu; ?></td>


    <td><?php echo $eloboostsipariscek['ilk10macsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['ilk10macsiparis_hesapad']; ?></td>

    <td><?php echo $eloboostsipariscek['ilk10macsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['ilk10macsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['ilk10macsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['ilk10macsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['ilk10macsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
