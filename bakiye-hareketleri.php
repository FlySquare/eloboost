...
<html lang="tr">
	<head>
		...
		<title><?php echo "Bakiye Hareketleri - ".$ayarcek['ayar_title']; ?></title>
    					...
    					<div class="row">
    						<div class="col-md-12">
    							<ol class="breadcrumb">
                                    ...
                                    <li class="active">Bakiye Haraketleri</li>
    							</ol>
    						</div>
    					</div>
    				</div>
		...
		<div class="clearfix">
			<nav>
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="bakiye-hareketleri"><i class="fa fa-list-alt pr-10"></i>BAKİYE HAREKETLERİ</a></li>
...
<!-- sidebar end -->
            ...
            <!-- main start -->
            						<!-- ================ -->
            						<div class="col-md-9">
            															<div class="text-center">Bu hesaba ait herhangi bir bakiye hareketi bulunamadı.</div>
            													</div>
            						<!-- main end -->
