...
$habersor=$db->prepare("SELECT * FROM bolfps_normalmacsiparis where normalmacsiparis_id=:id");
$habersor->execute(array(
  'id'=> $_GET['normalmacsiparis_id']
));
$habercek=$habersor->fetch(PDO::FETCH_ASSOC);
    $habersay = $habersor->rowCount();
    if(!$_GET['normalmacsiparis_id'] || $habersay<1){
                ...
                <div class="card-body">
                  <form action="../../db/islem.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input readonly="yes" type="text" class="form-control" name="oyunlar_foto" value="<?php echo $habercek['normalmacsiparis_karakter']; ?>" placeholder="Oyun fotoğrafını ekleyiniz.">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Sunucu</label>
                      <input readonly="yes" type="text" class="form-control" name="oyunlar_baslik" value="<?php
                      if ($habercek['normalmacsiparis_sunucu'] == "1") {
                        $busunucu = "TR";
                      }elseif ($habercek['normalmacsiparis_sunucu'] == "1.5") {
                      $busunucu = "EU";
                      }
                    ...
                    <div class="form-group">
                      ...
                      <input readonly="yes" type="text" class="form-control" name="oyunlar_baslik" value="<?php echo $habercek['normalmacsiparis_fiyat']; ?>&#8378;" placeholder="Oyun başlığını Giriniz.">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input readonly="yes" readonly="yes" type="text" class="form-control" name="oyunlar_baslik" value="<?php echo $habercek['normalmacsiparis_hesapad']; ?>" placeholder="Oyun başlığını Giriniz.">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Hesap Şifresi</label>
                      <input readonly="yes" type="text" class="form-control" name="oyunlar_foto" value="<?php echo $habercek['normalmacsiparis_hesapsifre']; ?>" placeholder="Oyun fotoğrafını ekleyiniz.">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tarih</label>
                      <input readonly="yes" type="text" class="form-control" name="oyunlar_baslik" value="<?php echo $habercek['normalmacsiparis_tarih']; ?>" placeholder="Oyun başlığını Giriniz.">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Durum (0-Bekliyor / 1-İşleme Alındı / 2-Tamamlandı / 3-İptal Edildi )</label>
                      <input  type="text" class="form-control" name="normalmacsiparis_durum" value="" placeholder="<?php
                    ...
                    <input type="hidden" name="normalmacsiparis_id" value="<?php echo $habercek['normalmacsiparis_id']; ?>">

                    <button type="submit" name="normalmacsiparisduzenle" class="btn btn-primary">Güncelle</button>
