                        ...
                        <div class="table-responsive p-3">
                          <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                            ...
                            <tbody>
                              ...
                              <?php while ($habercek=$urunsorv->fetch(PDO::FETCH_ASSOC)) {


                                ?>
                                <tr>
                                  <td><?php echo "#".$habercek['valorantelosiparis_id']; ?></td>
                                  <td><?php
                                  ...
                                  echo $habercek['valorantelosiparis_tarih'];

                                   ?></td>

                                  <td><?php

                                   echo $habercek['valorantelosiparis_sunucu']; ?></td>
                                  <td><?php echo $habercek['valorantelosiparis_fiyat']." ₺"; ?></td>
                                  <td><?php
                                  ...
                                  <td><a href="valorantelosiparisg.php?valorantelosiparis_id=<?php echo $habercek['valorantelosiparis_id']; ?>"><button type="submit" class="btn btn-primary">Görüntüle</button></a></td>
                                  <td><a href="../../db/islem.php?valorantelosiparis_id=<?php echo $habercek['valorantelosiparis_id']; ?>&urunsilv=ok"><button type="submit" class="btn btn-danger">Sil</button></a></td>
