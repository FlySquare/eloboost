        ...
        <!-- Container Fluid-->
                <div class="container-fluid" id="container-wrapper">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">challenger Boost Sipariş</h1>
                        ...
                        <div class="table-responsive p-3">
                          <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                            ...
                            <tbody>
                              ...
                              <?php while ($habercek=$urunsorchallenger->fetch(PDO::FETCH_ASSOC)) {


                                ?>
                                <tr>
                                  <td><?php echo "#".$habercek['challengerboostsiparis_id']; ?></td>
                                  <td><?php
                                ...
                                echo  $habercek['challengerboostsiparis_suankipuan']." - ".$habercek['challengerboostsiparis_istediginizpuan'];
                                  ...
                                  echo $habercek['challengerboostsiparis_tarih'];
                                  ...
                                  $busunucu = "EU";
                                   ...
                                   echo $busunucu; ?></td>
                                  <td><?php echo $habercek['challengerboostsiparis_fiyat']." ₺"; ?></td>
                                  <td><?php
                                  ...
                                  <td><a href="challengerboostsiparisg.php?challengerboostsiparis_id=<?php echo $habercek['challengerboostsiparis_id']; ?>"><button type="submit" class="btn btn-primary">Görüntüle</button></a></td>
                                  <td><a href="../../db/islem.php?challengerboostsiparis_id=<?php echo $habercek['challengerboostsiparis_id']; ?>&urunsilchallenger=ok"><button type="submit" class="btn btn-danger">Sil</button></a></td>
