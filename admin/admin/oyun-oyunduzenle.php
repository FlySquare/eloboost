...
$habersor=$db->prepare("SELECT * FROM bolfps_oyunlar where oyun_id=:id");
$habersor->execute(array(
  'id'=> $_GET['oyun_id']
));
$habercek=$habersor->fetch(PDO::FETCH_ASSOC);
    $habersay = $habersor->rowCount();
    if(!$_GET['oyun_id'] || $habersay<1){
...
<head>
  ...
  <title>Oyun Düzenle | <?php echo $ayarcek['ayar_title']; ?></title>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Oyun Düzenle</h6>
                ...
                <div class="card-body">
                  <form action="../../db/islem.php" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="oyunlar_foto" value="<?php echo $habercek['oyunlar_foto']; ?>" placeholder="Oyun fotoğrafını ekleyiniz.">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Oyun Başlık</label>
                      <input type="text" class="form-control" name="oyunlar_baslik" value="<?php echo $habercek['oyunlar_baslik']; ?>" placeholder="Oyun başlığını Giriniz.">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="oyunlar_aciklama" ><?php echo $habercek['oyunlar_aciklama']; ?></textarea>
                    </div>
                    <input type="hidden" name="oyun_id" value="<?php echo $habercek['oyun_id']; ?>">

                    <button type="submit" name="oyunlarduzenle" class="btn btn-primary">Güncelle</button>
