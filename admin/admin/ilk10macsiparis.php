        ...
        <!-- Container Fluid-->
                <div class="container-fluid" id="container-wrapper">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">İlk 10 Maç Sipariş</h1>
                        ...
                        <div class="table-responsive p-3">
                          <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                            ...
                            <tbody>
                              ...
                              <?php while ($habercek=$urunsor10->fetch(PDO::FETCH_ASSOC)) {


                                ?>
                                <tr>
                                  <td><?php echo "#".$habercek['ilk10macsiparis_id']; ?></td>
                                  <td><?php
                                  ...
                                  echo $habercek['ilk10macsiparis_tarih'];
                                  ...
                                  $busunucu = "EU";
                                   ...
                                   echo $busunucu; ?></td>
                                  <td><?php echo $habercek['ilk10macsiparis_fiyat']." ₺"; ?></td>
                                  <td><?php
                                  ...
                                  <td><a href="ilk10macsiparisg.php?ilk10macsiparis_id=<?php echo $habercek['ilk10macsiparis_id']; ?>"><button type="submit" class="btn btn-primary">Görüntüle</button></a></td>
                                  <td><a href="../../db/islem.php?ilk10macsiparis_id=<?php echo $habercek['ilk10macsiparis_id']; ?>&urunsil10=ok"><button type="submit" class="btn btn-danger">Sil</button></a></td>
