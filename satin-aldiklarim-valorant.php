...
<html lang="tr">
	<head>
		...
		<title><?php echo "Valorant Boost - ".$ayarcek['ayar_title']; ?></title>
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li><i class="fa fa-shopping-cart pr-10"></i><a href="/hesabim/satin-aldiklarim">Satın Aldıklarım</a></li>
								<li class="active">Valorant Boost Kategorileri</li>
							</ol>
						</div>
					</div>
				</div>
...
<!-- sidebar end -->
		...
		<li role="presentation" ><a href="satin-aldiklarim">LOL ELO BOOST</a></li>
		<li role="presentation" class="active"><a href="satin-aldiklarim-valorant">VALORANT BOOST</a></li>
							...
							<div class="row">
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-veloboost">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/valorant/ranked.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															ELO BOOST
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $valorantelosiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-vduoboost">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/valorant/duo.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															Duo Boost
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $valorantduoboostsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-vilk5mac">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/valorant/unranked.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															İlk 5 Maç
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $ilk5macsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-vnormalmac">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/valorant/win.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															Normal Maç
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $normalmacsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
