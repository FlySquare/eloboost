...
<html lang="tr">
	<head>
		...
		<title><?php echo "Satın Aldıklarım - ".$ayarcek['ayar_title']; ?></title>
					...
					<div class="row">
						<div class="col-md-12">
							<ol class="breadcrumb">
								...
								<li class="active">Elo Boost Kategorileri</li>
							</ol>
						</div>
					</div>
				</div>
...
<!-- sidebar end -->
    ...
    <li role="presentation" class="active"><a href="satin-aldiklarim">LOL ELO BOOST</a></li>
    <li role="presentation" class=""><a href="satin-aldiklarim-valorant">VALORANT BOOST</a></li>
...
<hr>
							<div class="row">
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-eloboost">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/lol/boost/eloboost.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															ELO BOOST
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $eloboostsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-ilk10mac">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/lol/boost/yerlestirme.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															İlk 10 Maç
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $ilk10macsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-duoboost">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/lol/boost/duo.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															Duo Boost
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $duoboostsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-winboost">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/lol/boost/netwin.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															Win Boost
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $winboostsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
									...
									<div class="col-md-4">
										<div class="wrimagecard wrimagecard-topimage">
											<a href="satinalinan-challenger">
													<div class="wrimagecard-topimage_header" style="background-color:rgba(187, 120, 36, 0.1) ">
														<img src="/frontend/images/lol/boost/challengerboost.png" class="img-center">
													</div>
													<div class="wrimagecard-topimage_title">
														<h5>
															Challenger Boost
															<div class="pull-right badge" style="font-size: 14px;"><?php echo $challengerboostsiparissay; ?></div>
														</h5>
													</div>
											</a>
										</div>
							...
							<small><strong class="text-danger">BİLGİ:</strong> Sipariş kategorilerine tıklayarak kategoriye ait satın aldığınız boost siparişlerinizi listeleyebilir ve sipariş detaylarına ulaşabilirsiniz.</small>
