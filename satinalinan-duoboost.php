...
<html lang="tr">
	<head>
		...
		<title><?php echo "Satın Alınan Duo Boost - ".$ayarcek['ayar_title']; ?></title>
	...
	<body class="front">
		...
		<div class="page-wrapper">
			...
			<div class="page-intro">
                ...
                <li><i class="fa fa-cubes pr-10"></i><a href="satin-aldiklarim">Elo Boost Kategorileri</a></li>

								<li class="active">Duo Boost</li>
							</ol>
						</div>
					</div>
				</div>
...
<!-- sidebar end -->
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Mevcut Lig - Aşama</th>
      <th scope="col">Hedef Lig - Aşama</th>
      <th scope="col">Maç Başı Lp</th>
      <th scope="col">Sunucu</th>
      <th scope="col">Dereceli Tür</th>
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$duoboostsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['duoboostsiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['duoboostsiparis_mevcutlig'] == 6) {
        $lig = "Elmas";

      }
     echo $lig." / ".$eloboostsipariscek['duoboostsiparis_mevcutasama'];
     ?></td>
    <td><?php
    if ($eloboostsipariscek['duoboostsiparis_hedeflig'] == 1) {
      $lig2 = "Demir";

    }elseif ($eloboostsipariscek['duoboostsiparis_hedeflig'] == 2) {
      $lig2 = "Bronz";

    }elseif ($eloboostsipariscek['duoboostsiparis_hedeflig'] == 3) {
      $lig2 = "Gümüş";

    }elseif ($eloboostsipariscek['duoboostsiparis_hedeflig']== 4) {
      $lig2 = "Altın";

    }elseif ($eloboostsipariscek['duoboostsiparis_hedeflig'] == 5) {
      $lig2 = "Platin";

    }elseif ($eloboostsipariscek['duoboostsiparis_hedeflig'] == 6) {
      $lig2 = "Elmas";

    }
     echo $lig2." / ".$eloboostsipariscek['duoboostsiparis_hedefasama']; ?></td>
    <td><?php
    if ($eloboostsipariscek['duoboostsiparis_macbasilp'] == "1") {
      $macbasilp = "20+";
    }elseif ($eloboostsipariscek['duoboostsiparis_macbasilp'] == "1.1") {
    $macbasilp = "17-19";
    }elseif ($eloboostsipariscek['duoboostsiparis_macbasilp'] == "1.2") {
    $macbasilp = "15-16";
    }elseif ($eloboostsipariscek['duoboostsiparis_macbasilp'] == "1.3") {
      $macbasilp = "0-15";
    }

    echo $macbasilp; ?></td>
    <td><?php
    if ($eloboostsipariscek['duoboostsiparis_sunucu'] == "1") {
      $busunucu = "TR";
    }elseif ($eloboostsipariscek['duoboostsiparis_sunucu'] == "1.5") {
    $busunucu = "EU";
    }
     echo $busunucu; ?></td>
     <td><?php if ($eloboostsipariscek['duoboostsiparis_derecelitur'] == "1") {
       echo "Tek-Çift";
     }elseif ($eloboostsipariscek['duoboostsiparis_derecelitur'] == "2") {
       echo "Esnek";
     } ?></td>
    <td><?php echo $eloboostsipariscek['duoboostsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['duoboostsiparis_hesapadi']; ?></td>
    <td><?php echo $eloboostsipariscek['duoboostsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['duoboostsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['duoboostsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['duoboostsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['duoboostsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
