...
<html lang="tr">
	<head>
		...
		<title><?php echo "Hesabım - ".$ayarcek['ayar_title']; ?></title>
								...
								<div class="clearfix">
									<nav>
										<ul class="nav nav-pills nav-stacked">
											<li class="active"><a href="hesabim"><i class="fa fa-user-circle pr-10"></i>Hesabım</a></li>
...
<!-- sidebar end -->
						<!-- main start -->
						<!-- ================ -->
						<div class="main col-md-9" style="margin-top: -18px;">
                                ...
                                <div class="col-md-12">
                                    <form>
                                        <div class="form-group" style="margin-top: -18px;">
                                            ...
                                            <input type="text" class="form-control" id="kullaniciadi" value="<?php echo $girisyapanusercek['user_username']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="eposta">E-posta</label>
                                            <input type="text" class="form-control" id="eposta" value="<?php echo $girisyapanusercek['user_eposta']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                                <label for="telefon">Telefon</label>
                                                <input type="text" class="form-control" id="telefon" value="<?php echo $girisyapanusercek['user_tel']; ?>" readonly>
										</div>
										<div class="form-group">
                                                <label for="telefon">Bakiye</label>
                                                <input type="text" class="form-control" id="telefon" value="<?php echo $girisyapanusercek['user_bakiye']; ?>₺" readonly>
                                        </div>
                                    </form>
                                </div>
