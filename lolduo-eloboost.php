...
<html lang="tr">
	<head>
		...
		<title><?php echo "Lol Duo Boost - ".$ayarcek['ayar_title']; ?></title>
...
<!-- section start -->
                ...
                <div class="col-md-2 bhoechie-tab-menu">
                  ...
                  <a href="lolduo-eloboost.php" class="list-group-item active text-center">
                  ...
                  <a href="challenger-eloboost.php" class="list-group-item text-center">
                    <img src="/frontend/images/lol/boost/challengerboost.png"><p class="boostB">Challenger Boost</p>
								...
								<div class="col-md-9 bhoechie-tab">
									...
									<div class="bhoechie-tab-content active">
										...
										<h1 class="text-center"><strong>LOL Duo Boost Hizmeti
</strong></h1>
										<span class="text-center f4">Eşli Lig Yükseltme
</span>
                    ...
                    <form id="boost_form" action="db/islem.php" method="post" @submit="buyBoost">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="match_lp" id="match_lp" v-model="match_lp" required>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="ranked_type" id="ranked_type" v-model="ranked_type" required>
                          ...
                          <option v-bind:value="2">Esnek</option>
											...
											<?php
											if ($duoboostfiyatcek['lolduofiyat_indirimdurum'] == "1") {
												?>
                      ...
                      <input type="hidden" name="macbasilp" id="macbasilp" value="">
...
function gonder(tur){
	...
	var app = new Vue({
		...
		data: {
			...
			ranked_type: 1,
			priceList: { 1: <?php echo $duoboostfiyatcek['lolduofiyat_demir']; ?>, 2: <?php echo $duoboostfiyatcek['lolduofiyat_bronz']; ?>, 3: <?php echo $duoboostfiyatcek['lolduofiyat_gumus']; ?>, 4: <?php echo $duoboostfiyatcek['lolduofiyat_altin']; ?>, 5: <?php echo $duoboostfiyatcek['lolduofiyat_platin']; ?>, 6: <?php echo $duoboostfiyatcek['lolduofiyat_elmas']; ?>},
		},
		methods: {
			calcOrder() {
				var price = 0;
				...
				if ($duoboostfiyatcek['lolduofiyat_indirimdurum'] == "1") {
					?>
					this.after_discount_boost_order = (this.pre_discount_boost_order * <?php echo $duoboostfiyatcek['lolduofiyat_indirim']; ?>).toFixed(0);
