...
<html lang="tr">
	<head>
		...
		<title><?php echo "Valorant Elo Boost - ".$ayarcek['ayar_title']; ?></title>
...
<!-- section start -->
				...
				<div class="section">
							...
							<div class="col-md-12 bhoechie-tab-container">
								...
								<div class="col-md-2 bhoechie-tab-menu">
								  <div class="list-group">
									<a href="valorant-eloboost" class="list-group-item active text-center">
								...
								<div class="col-md-9 bhoechie-tab">
									...
									<div class="bhoechie-tab-content active">
										...
										<h1 class="text-center"><strong>Elo Boost Hizmeti</strong></h1>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="server" id="server" v-model="server" required>
                          ...
                          <option v-bind:value="1">TR</option>
											...
											<?php
											if ($valorantelofiyatcek['valorantelofiyat_indirimdurum'] == "1") {
												?>
                    ...
                    <?php if (isset($_SESSION['user_username'])): ?>
											<center>  <button name="valoranteloboost"
													type="submit"
...
data: {
	...
	ranked_type: 1,
	priceList: { 1: <?php echo $valorantelofiyatcek['valorantelofiyat_demir']; ?>, 2: <?php echo $valorantelofiyatcek['valorantelofiyat_bronz']; ?>, 3: <?php echo $valorantelofiyatcek['valorantelofiyat_gumus']; ?>, 4: <?php echo $valorantelofiyatcek['valorantelofiyat_altin']; ?>, 5: <?php echo $valorantelofiyatcek['valorantelofiyat_platin']; ?>, 6: <?php echo $valorantelofiyatcek['valorantelofiyat_elmas']; ?> ,7: <?php echo $valorantelofiyatcek['valorantelofiyat_olumsuzluk']; ?>,8: <?php echo $valorantelofiyatcek['valorantelofiyat_isiyan']; ?> },
},
methods: {
	calcOrder() {
		var price = 0;
		...
		if ($valorantelofiyatcek['valorantelofiyat_indirimdurum'] == "1") {
			?>
			this.after_discount_boost_order = (this.pre_discount_boost_order * <?php echo $valorantelofiyatcek['valorantelofiyat_indirim']; ?>).toFixed(0);
