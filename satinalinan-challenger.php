...
<html lang="tr">
	<head>
		...
		<title><?php echo "Satın Alınan Challenger Boost - ".$ayarcek['ayar_title']; ?></title>
		...
		<div class="page-wrapper">
			...
			<div class="page-intro">
                ...
                <li><i class="fa fa-cubes pr-10"></i><a href="satin-aldiklarim">Elo Boost Kategorileri</a></li>
								...
								<li class="active">Challenger Boost</li>
							</ol>
						</div>
					</div>
				</div>
...
<!-- sidebar end -->
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Şuanki Puan</th>
      <th scope="col">İstenilen Puan</th>
      <th scope="col">Koridor</th>
      <th scope="col">Dereceli Tür</th>
      <th scope="col">Sunucu</th>
      <th scope="col">Maç Başı Puan</th>
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$challengerboostsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['challengerboostsiparis_id']; ?></th>
    <td><?php

     echo $eloboostsipariscek['challengerboostsiparis_suankipuan'];
     ?></td>
    <td><?php

    echo $eloboostsipariscek['challengerboostsiparis_istediginizpuan']; ?></td>
    <td><?php
    if ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1") {
      $macbasilp = "Farketmez";
    }elseif ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1.3") {
    $macbasilp = "ADC";
    }elseif ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1.2") {
    $macbasilp = "MID";
  }elseif ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1.25") {
      $macbasilp = "TOP";
    }elseif ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1.21") {
    $macbasilp = "JUNGLE";
  }elseif ($eloboostsipariscek['challengerboostsiparis_koridor'] == "1.31") {
      $macbasilp = "SUPPORT";
    }

    echo $macbasilp; ?></td>
    <td><?php if ($eloboostsipariscek['challengerboostsiparis_derecelitur'] == "1") {
      echo "Tek-Çift";
    }elseif ($eloboostsipariscek['challengerboostsiparis_derecelitur'] == "2") {
      echo "Esnek";
    } ?></td>
    <td><?php
    if ($eloboostsipariscek['challengerboostsiparis_sunucu'] == "1") {
      $busunucu = "TR";
    }elseif ($eloboostsipariscek['challengerboostsiparis_sunucu'] == "1.5") {
    $busunucu = "EU";
    }
     echo $busunucu; ?></td>
     <td><?php
     if ($eloboostsipariscek['challengerboostsiparis_macbasipuan'] == "1") {
       $macbasilp = "18-25";
     }elseif ($eloboostsipariscek['challengerboostsiparis_macbasipuan'] == "1.5") {
     $macbasilp = "13-17";
   }elseif ($eloboostsipariscek['challengerboostsiparis_macbasipuan'] == "2") {
     $macbasilp = "1-12";
     }

     echo $macbasilp; ?></td>

    <td><?php echo $eloboostsipariscek['challengerboostsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['challengerboostsiparis_hesapad']; ?></td>
    <td><?php echo $eloboostsipariscek['challengerboostsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['challengerboostsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['challengerboostsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['challengerboostsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['challengerboostsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
