...
<html lang="tr">
	<head>
		...
		<title><?php echo "İlk 10 Maç - ".$ayarcek['ayar_title']; ?></title>
...
<!-- section start -->
                ...
                <div class="col-md-2 bhoechie-tab-menu">
                  ...
                  <a href="ilk10mac-eloboost.php" class="list-group-item active text-center">
                    ...
                    <img src="/frontend/images/lol/boost/challengerboost.png"><p class="boostB">Challenger Boost</p>
								...
								<div class="col-md-9 bhoechie-tab">
									...
									<div class="bhoechie-tab-content active">
										...
										<h1 class="text-center"><strong>LOL İlk 10 Maç Hizmeti
            ...
            <div class="form-group">
              ...
              <select class="form-control" class="eloboost-form" name="duo_boost" id="duo_boost" v-model="duo_boost" required>
                <option disabled value="0">Seçiniz</option>
             ...
             <div class="form-group">
               ...
               <input type="password" name="hesapsifre" required class="form-control">
					...
					<?php if (isset($_SESSION['user_username'])): ?>
						<center>  <button name="ilk10macsatinal" type="submit" class="btn btn-success"
...
data: {
  ...
  server: 1,
  duo_boost: 1,
  priceList: { 1: <?php echo $ilk10macfiyatcek['ilk10macfiyat_demir']; ?>, 2: <?php echo $ilk10macfiyatcek['ilk10macfiyat_bronz']; ?>, 3: <?php echo $ilk10macfiyatcek['ilk10macfiyat_gumus']; ?>, 4: <?php echo $ilk10macfiyatcek['ilk10macfiyat_altin']; ?>, 5: <?php echo $ilk10macfiyatcek['ilk10macfiyat_platin']; ?>, 6: <?php echo $ilk10macfiyatcek['ilk10macfiyat_elmas']; ?>},
