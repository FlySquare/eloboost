...
<html lang="tr">
	<head>
		...
		<title><?php echo "Elo Boost - ".$ayarcek['ayar_title']; ?></title>
							...
							<div class="col-md-12 bhoechie-tab-container">
								...
								<div class="col-md-2 bhoechie-tab-menu">
								  <div class="list-group">
									<a href="lol-eloboost.php" class="list-group-item active text-center">
...
function gonder(tur){
	...
	var app = new Vue({
		...
		data: {
			...
			ranked_type: 1,
			priceList: { 1: <?php echo $eloboostfiyatcek['olelofiyat_demir']; ?>, 2: <?php echo $eloboostfiyatcek['olelofiyat_bronz']; ?>, 3: <?php echo $eloboostfiyatcek['olelofiyat_gumus']; ?>, 4: <?php echo $eloboostfiyatcek['olelofiyat_altin']; ?>, 5: <?php echo $eloboostfiyatcek['olelofiyat_platin']; ?>, 6: <?php echo $eloboostfiyatcek['olelofiyat_elmas']; ?> ,7: <?php echo $eloboostfiyatcek['lolelofiyat_ustalik']; ?> },
		},
		methods: {
			calcOrder() {
				var price = 0;
				...
				if ($eloboostfiyatcek['olelofiyat_indirimdurum'] == "1") {
					?>
					this.after_discount_boost_order = (this.pre_discount_boost_order * <?php echo $eloboostfiyatcek['olelofiyat_indirim']; ?>).toFixed(0);
