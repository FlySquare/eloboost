...
<html lang="tr">
	<head>
		...
		<title><?php echo "Valorant Normal Maç Boost - ".$ayarcek['ayar_title']; ?></title>
							...
							<div class="col-md-12 bhoechie-tab-container">
								...
								<div class="col-md-2 bhoechie-tab-menu">
								  <div class="list-group">
									...
									<a href="valorant-normalmac" class="list-group-item active text-center">
								...
								<div class="col-md-9 bhoechie-tab">
									...
									<div class="bhoechie-tab-content active">
										...
										<h1 class="text-center"><strong>Normal Maç Hizmeti

</strong></h1>
										<span class="text-center f4">Derecesiz Maçlar
             ...
             <div class="form-group">
               ...
               <input type="password" name="hesapsifre" required class="form-control">
					...
					<?php if (isset($_SESSION['user_username'])): ?>
						<center>  <button name="normalmacsat" type="submit" class="btn btn-success"
