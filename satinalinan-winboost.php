...
<html lang="tr">
	<head>
		...
		<title><?php echo "Satın Alınan Win Boost - ".$ayarcek['ayar_title']; ?></title>
...
<!-- sidebar end -->
  ...
  <thead>
    <tr>
      <th scope="col">#</th>
      <th scope="col">Mevcut Küme / Aşama</th>
  ...
  <tbody>
  <?php
while ($eloboostsipariscek=$winboostsiparissor->fetch(PDO::FETCH_ASSOC)) {
  ?>
  <tr>
    <th scope="row"><?php echo "#".$eloboostsipariscek['winboostsiparis_id']; ?></th>
    <td><?php

      if ($eloboostsipariscek['winboostsiparis_sonlig'] == 1) {
        $lig = "Demir";

      }elseif ($eloboostsipariscek['winboostsiparis_sonlig'] == 2) {
        $lig = "Bronz";

      }elseif ($eloboostsipariscek['winboostsiparis_sonlig'] == 3) {
        $lig = "Gümüş";

      }elseif ($eloboostsipariscek['winboostsiparis_sonlig'] == 4) {
        $lig = "Altın";

      }elseif ($eloboostsipariscek['winboostsiparis_sonlig'] == 5) {
        $lig = "Platin";

      }elseif ($eloboostsipariscek['winboostsiparis_sonlig'] == 6) {
        $lig = "Elmas";

      }
     echo $lig." / ".$eloboostsipariscek['winboostsiparis_mevcutasama'];
     ?></td>
    <td><?php echo $eloboostsipariscek['winboostsiparis_toplammac']; ?></td>

    <td><?php
    if ($eloboostsipariscek['winboostsiparis_sunucu'] == "1") {
      $busunucu = "TR";
    }elseif ($eloboostsipariscek['winboostsiparis_sunucu'] == "1.5") {
    $busunucu = "EU";
    }
     echo $busunucu; ?></td>


    <td><?php echo $eloboostsipariscek['winboostsiparis_fiyat']; ?>&#8378;</td>
    <td><?php echo $eloboostsipariscek['winboostsiparis_hesapad']; ?></td>

    <td><?php echo $eloboostsipariscek['winboostsiparis_tarih']; ?></td>
    <td><?php
    if ($eloboostsipariscek['winboostsiparis_durum'] == "0") {
      echo "Bekliyor";
    }elseif ($eloboostsipariscek['winboostsiparis_durum'] == "1") {
      echo "İşleme Alındı";
    }elseif ($eloboostsipariscek['winboostsiparis_durum'] == "2") {
      echo "Tamamlandı";
    }elseif ($eloboostsipariscek['winboostsiparis_durum'] == "3") {
      echo "İptal Edildi";
    }
     ?></td>
  </tr>
