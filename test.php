                    ...
                    <form id="boost_form" action="db/islem.php" method="post" @submit="buyBoost">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="ltarget_stage" id="ltarget_stage" v-model="ltarget_stage" required>
														...
														<option v-bind:value="1.2">JUNGLE (+%20)</option>
														<option v-bind:value="1.3">SUPPORT (+%30) </option>
                        </select>
                      </div>

                      <div class="form-group">
                        <div class="input-group-prepend">
                          <label class="input-group-text" for="lcurrent_rank">Maç Başına Gelen Puan</label>
                        </div>
			...
			calcOrder() {
				...
				if ($challengerboostfiyatcek['challengerboostfiyat_indirimdurum'] == 1) {
					...
					if (this.lcurrent_stage - this.lcurrent_rank < 25) {
						...
						this.pre_discount_boost_order = (this.lcurrent_stage - this.lcurrent_rank)*3*this.ltarget_rank*this.ltarget_stage*this.match_lp*this.server*this.ranked_type;
