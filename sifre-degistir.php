...
<html lang="tr">
	<head>
		...
		<title><?php echo "Şifre Değiştir - ".$ayarcek['ayar_title']; ?></title>
								...
								<div class="clearfix">
									<nav>
										<ul class="nav nav-pills nav-stacked">
											...
											<li class="active"><a href="sifre-degistir"><i class="fa fa-key pr-10"></i>ŞİFRE DEĞİŞTİR</a></li>
										</ul>
									</nav>
								</div>
							</div>
...
<div class="col-md-9" style="">
    ...
    <form style="margin-top: 0px;" action="../db/islem.php" method="POST">
      <div class="form-group has-feedback ">
        <label for="exampleInputEmail1">Mevcut Şifre <span class="text-danger small">*</span></label>
        <input type="password" class="form-control" id="sifre" name="suankisifre" placeholder="Mevcut şifreniz">
                            </div>
      <div class="form-group has-feedback ">
        <label for="exampleInputEmail1">Yeni Şifre <span class="text-danger small">*</span></label>
        <input type="password" class="form-control" id="yenisifre" name="yenisifre" placeholder="Yeni şifreniz">
                            </div>
      <div class="form-group has-feedback ">
        <label for="exampleInputEmail1">Yeni Şifre Tekrarı <span class="text-danger small">*</span></label>
        <input type="password" class="form-control" id="yenisifretekrar" name="yenisifretekrar" placeholder="Yeni şifrenizin tekrarı">
                            </div>
      <button type="submit" name="usersifredegis" class="btn btn-default">DEĞİŞTİR</button>
